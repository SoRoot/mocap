...
(function() {
 var loadPackage = function(metadata) {
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 23267594;
      var PACKAGE_UUID = 'c522fb88-f4f8-4126-a5cf-efa8faf99d55';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 20400, 0, 0).open('GET', '/globalgamemanagers');
    new DataRequest(20400, 31320, 0, 0).open('GET', '/globalgamemanagers.assets');
    new DataRequest(31320, 50648, 0, 0).open('GET', '/level0');
    new DataRequest(50648, 50669, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(50669, 50793, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(50793, 20286961, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(20286961, 21681869, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(21681869, 23179241, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(23179241, 23239969, 0, 0).open('GET', '/Resources/unity_builtin_extra');
    new DataRequest(23239969, 23267594, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
